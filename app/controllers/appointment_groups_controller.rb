  ...
  def create
    ...
    respond_to do |format|
      if @appointment_group.save
        format.html do
          redirect_to appointment_group_url(@appointment_group), notice: 'Appointment group was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @appointment_group.update(appointment_group_params)
        format.html do
          redirect_to appointment_group_url(@appointment_group), notice: 'Appointment group was successfully updated.'
        end
