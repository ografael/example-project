...
RSpec.describe 'appointment_question_responses/edit' do
  before do
  ...
  it 'renders the edit appointment_question_response form' do
    ...
    assert_select 'form[action=?][method=?]', appointment_question_response_path(@appointment_question_response),
                  'post' do
